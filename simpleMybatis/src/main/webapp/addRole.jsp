    ...
    <form method="post" id="demo1" class="layui-form layui-form-pane">
        <div class="form">
            <div class="item">
                ...
                <input type="text" name="rname" placeholder="RoleName" lay-verify="required">
            </div>
            <div class="item">
                <i class="fa fa-bookmark-o" aria-hidden="true"></i>
                <input type="text" name="rremark" placeholder="RoleMark">
            </div>
        </div>
...
<script>
    layui.use(['form','jquery','layer'],function () {
        ...
        form.on('submit(demo1)',function (data) {
            ...
            console.log(json);
            $.post("addNewRole",json,function (data) {
                if(data!="0"){
