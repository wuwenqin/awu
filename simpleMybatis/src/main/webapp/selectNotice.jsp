    ...
    layui.use(['table','form'], function(){
        ...
        tableIns=table.render({
            ...
            ,cols: [[
                ...
                ,{field:'title', title:'标题', width:'15%', edit: 'text'}
                ,{field:'name', title:'名称', width:'15%', edit: 'text'}
                ,{field:'content', title:'内容', width:'30%', edit: 'text', sort: true}
                ,{field:'userid', title:'发布人', width:'8%'}
                ,{field:'remark', title:'备注', width:'14%', sort: true,edit: 'text'}
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('真的删除行么', function(index){
                    obj.del();
                    var json={"id":data.id};
                    $.post("deleteByNotice",json,function (data) {
                        if(data!="0"){
